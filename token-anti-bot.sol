...
/**
 * It is example of a AntiBot Token from VladimirGav
...
contract AntiBot is Ownable {
    ...
    function checkAntiBot(uint256 _amountTransfer) public returns (bool) {
...
contract SimpleToken is Ownable, IERC20, AntiBot {
    using SafeMath for uint256;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        require(sender == owner() || AntiBot.checkAntiBot(amount), "AntiBot"); // checkAntiBot
